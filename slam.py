...
# Input filenames
pose_data_file = "SLAM_Data/pose_data.npz"
scan_data_file = "SLAM_Data/scan_data.npz"

# Output filenames
slam_map_file = "SLAM_Data/my_slam_map.png"
save_ogm_file = "SLAM_Data/occupancy_map.npy"
save_opt_poses_file = "SLAM_Data/optimized_poses.csv"
...
def quick_start_template():
    ...
    slam = GraphSLAM(
        ...
        origin=(-3, -7)  # lower left corner (meters) w/r/t origin
    )
